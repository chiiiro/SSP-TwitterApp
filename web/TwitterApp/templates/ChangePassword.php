            ...
            <form class="form-horizontal" id="change-pwd-form" role="form" method="post" action="">
                ...
                <div class="form-group">
                    <div class="col-md-4 col-md-offset-4">
                        <input type="password" class="form-control" name="first" id="first" placeholder="Enter new password" required>
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-md-4 col-md-offset-4">
                        <input type="password" class="form-control" name="second" id="second" placeholder="Confirm new password" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-4 col-md-offset-4">
                        <input type="submit" class="btn btn-info btn-block" name="change-pwd" id="change-pwd" value="Submit changes">
                    </div>
                </div>
